...
- the problem or confusion you observed
- the workflow file, stage, or command involved, if known
- what behavior you expected
- what happened instead
- any suggested improvement
- a minimal example, if the issue depends on a specific research workflow
...
- suggestions that may help researchers use the system more effectively
...
so more researchers can find it.
