...
- In autonomous or goal-driven runs, never let the AI proxy the human for the Micro-Example Gate, Minimal Model Base Gate, main theorem gate, novelty claim, contribution lock, target decision, or invest/pivot/kill decision. The AI may recommend; the human must confirm.
